...
public:
	...
	UFUNCTION(BlueprintCallable);
	TSubclassOf<AGunBase>* GetCurrentWeapon();

	UFUNCTION(BlueprintCallable);
	virtual void DropWeapon(int slot);
...
public:
	...
	UPROPERTY(EditAnywhere)
		TSubclassOf<class AGunBase>* PrimWep;

	UPROPERTY(EditAnywhere)
		TSubclassOf<class AGunBase>* SecWep;

	UPROPERTY(EditAnywhere)
		TSubclassOf<class AGunBase>* ObjWep;
